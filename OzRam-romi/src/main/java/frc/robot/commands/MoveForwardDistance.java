...
/**
  ...
  public void execute() {
    ...
    var leftdrive  =(m_targetdistance-m_subsystem.getLeftDistanceInch())*0.05  + Math.signum((m_targetdistance-m_subsystem.getLeftDistanceInch()))* 0.06; 
    var rightdrive =(m_targetdistance-m_subsystem.getRightDistanceInch())*0.05 + Math.signum((m_targetdistance-m_subsystem.getRightDistanceInch()))* 0.06;
